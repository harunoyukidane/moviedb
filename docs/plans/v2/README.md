...
| View toggle, cast/credits presentation, people photos, action icons | [frontend.md](frontend.md) | 🟡 partial (list components extracted; toggle/credits/photos/icons remain) |
